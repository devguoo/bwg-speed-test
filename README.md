...
|------|------|------|-----------|------|--------|
| 香港 HKHK_8 | 香港 | CMI | ~84 | ✅ 正常 | ⭐⭐⭐⭐⭐ |
| 日本东京 | 东京 | CN2 GIA | ~187 | ✅ 正常 | ⭐⭐⭐⭐ |
| DC6 USCA_6 | 洛杉矶 | CN2 GIA-E | ~231 | ⚠️ 绕路 | ⭐⭐⭐ |
| 荷兰 EUNL_9 | 阿姆斯特丹 | 联通9929 | ~264 | ⚠️ 绕路 | ⭐⭐⭐ |
| DC4 USCA_4 | 洛杉矶 | MCOM | ~323 | ⚠️ 绕路 | ⭐⭐ |
| DC2 USCA_2 | 洛杉矶 | QN | ~339 | ⚠️ 绕路 | ⭐⭐ |
| DC9 USCA_9 | 洛杉矶 | CN2 GIA | — | ❌ 不可达 | — |
| 日本大阪 | 大阪 | CN2 GIA | — | ❌ 不可达 | — |
| DC3 USCA_3 | 洛杉矶 | CN2 | — | ❌ 不可达 | — |
| DC8 USCA_8 | 洛杉矶 | CN2 | — | ❌ 不可达 | — |
| 迪拜 AEDXB_1 | 迪拜 | — | — | ❌ 不可达 | — |

> ⚠️ **2026-03-05 路由观察**：香港 CMI 线路表现优异（84ms），日本东京正常（187ms）；DC6/荷兰/DC4/DC2 延迟偏高，疑似路由绕路；DC9/大阪/DC3/DC8/迪拜不可达。凌晨路由波动属常见现象，白天通常恢复。
>
