...
| DC4 USCA_4 | 洛杉矶 | MCOM | ~233 | ⚠️ 绕路 | ⭐⭐⭐ |
| DC6 USCA_6 | 洛杉矶 | CN2 GIA-E | ~252 | ⚠️ 绕路 | ⭐⭐⭐ |
| 荷兰 EUNL_9 | 阿姆斯特丹 | 联通9929 | ~276 | ⚠️ 绕路 | ⭐⭐⭐ |
| DC2 USCA_2 | 洛杉矶 | QN | ~316 | ⚠️ 绕路 | ⭐⭐ |
...
> ⚠️ **2026-03-11 路由观察**：香港 CMI 线路继续最佳（84ms），日本东京维持可用（187ms）；DC4/DC6/荷兰/DC2 延迟偏高，存在明显绕路；DC3/DC8/DC9/大阪/迪拜 仍不可达。
>
